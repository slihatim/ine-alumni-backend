          ...
          <div className="flex">
            ...
            {!auth && (
              <Link to="/se-connecter">
                <Button className="rounded-2xl font-bold cursor-pointer ml-4 shadow-md focus:border-2 focus:border-[#0c5f95] flex bg-[#5691cb] hover:bg-[#0c5f95] text-white">
                  Se connecter
                </Button>
              </Link>
            )}
            ...
            {auth && (
              <Button
                className="rounded-2xl font-bold cursor-pointer ml-4 shadow-md focus:border-2 focus:border-[#0c5f95] flex bg-[#5691cb] hover:bg-[#0c5f95] text-white"
                onClick={logout}
              >
                Se déconnecter
              </Button>
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-48 mt-2">
        ...
        <DropdownMenuItem>
          <Link to="/ressources" className="w-full">
            Ressources
          </Link>
        </DropdownMenuItem>
      </DropdownMenuContent>
