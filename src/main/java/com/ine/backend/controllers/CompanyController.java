...
public class CompanyController {
	...
	public ResponseEntity<PageResponseDTO<CompanyDTO>> getAllCompanies(
		...
		PageResponseDTO<CompanyDTO> response = companyService.getAllCompaniesWithAlumni(page, size, sortBy, sortDir);
	...
	public ResponseEntity<PageResponseDTO<CompanyDTO>> searchCompanies(
		...
		PageResponseDTO<CompanyDTO> response = companyService.searchCompanies(q, page, size);
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<PageResponseDTO<LaureatDTO>> getCompanyAlumni(
		...
		PageResponseDTO<LaureatDTO> response = companyService.getCompanyAlumni(id, page, size, sortBy, sortDir);
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<PageResponseDTO<CompanyReviewDTO>> getCompanyReviews(
		...
		PageResponseDTO<CompanyReviewDTO> response = companyService.getCompanyReviews(id, page, size);
		return ResponseEntity.ok(response);
	}
}
